...
namespace Clase_8
{
    public partial class frmEmpleado : Form
    {
        ...
        private void btnAgregarItem_Click(object sender, EventArgs e)
        {
            ...
            {
                empleado = new Accionista(txtNombre.Text, txtApellido.Text, salario);
            }
            else
            {
                empleado = new Empleado(txtNombre.Text, txtApellido.Text, mtxtLegajo.Text, puesto, salario);
            }
        ...
        private void cmbPuesto_SelectedValueChanged(object sender, EventArgs e)
        {
            Empleado.EPuestoJerarquico puesto;
            if (!Enum.TryParse<Empleado.EPuestoJerarquico>(cmbPuesto.SelectedValue.ToString(), out puesto))
            {
            ...
            if(puesto == Empleado.EPuestoJerarquico.Accionista)
            {
                mtxtSalario.Mask = "000%";
            }
            else
            {
                mtxtSalario.Mask = "$00000";
            }
        }
    }
}
